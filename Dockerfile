...
LABEL org.label-schema.name="volgactf-qualifier-database"
LABEL org.label-schema.description="VolgaCTF Qualifier database"
LABEL org.label-schema.url="https://volgactf.ru/en"
LABEL org.label-schema.vcs-url="https://github.com/VolgaCTF/volgactf-qualifier-database"
LABEL org.label-schema.vcs-ref=$VCS_REF
LABEL org.label-schema.version=$BUILD_VERSION

WORKDIR /app
COPY VERSION package*.json entrypoint.sh knexfile.js .
